<div class="top-notice bg-dark">
    <div class="container-fluid text-center">
        <p class="text-white ls-0 mb-0">
            Được giảm thêm 10% trong đợt giảm giá <strong>MÙA HÈ</strong> Love Studio - <a
                href="trang-chu">Shop!</a>
        </p>
    </div>
</div>
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <ul class="submenu">
                                            <?php
                                            require('db.php');
                                            $tv1 = "SELECT * FROM loai_tin_dichvu ORDER BY id ASC LIMIT 3";
