...
<?php
  ...
  if(isset($_REQUEST['list_id']) && $_REQUEST['list_id'] != ''){
	   ...
	   <script>window.location ="quan_tri.php?p=danhsach_masanpham"</script>
	<?php
	}
	...
	?>
    <script>window.location ="quan_tri.php?p=danhsach_masanpham&page=<?php echo $_GET['page'];?>"</script>
	<?php
	}
    ...
    <?php
	  ...
	  $result=mysqli_query($link,"SELECT * FROM ma_sanpham $loai ORDER BY id DESC limit $start,$limit");
	   while($row = mysqli_fetch_object($result))
	   {
		...
		echo  "<td align='center'><a href='quan_tri.php?p=sua_masanpham&id=".$id."&danhmuc=".$did1."&thuocloai=".$did."&page=".$_GET['page']."'><img src='images/sua_record.png' border='0'></a></td>";
